import { Archive, Timer, BarChart3, AtSign, CalendarDays, CalendarRange, CheckCircle2, FolderKanban, Megaphone, Tag, type LucideIcon } from 'lucide-react';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Baú', href: '/bau', icon: Archive },
